 ...
 *
 * (**notice**: we add additional blank row `sums[0][col+1]={0}` and blank column
 * `sums[row+1][0]={0}` to remove the edge case checking), so, we can have the following definition
 *
